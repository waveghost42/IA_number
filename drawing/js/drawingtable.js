...
$(function() {
	...
	$("#drawing-table").delegate("td", "touchstart", function() {
		...
		if (eraseState) {
			...
			$el.prepend( '<input style="display:none" type="checkbox"  id="subscribeNews" name="'+$(this).attr("id")+'" value="1" checked>');
			...
			xmlhttp.open("POST", "postdraw.php?"+$('form').serialize(), true);
			xmlhttp.send();
			$el.css("background", curColor);

		}
	});
	$("#drawing-table").delegate("td", "touchmove", function() {
